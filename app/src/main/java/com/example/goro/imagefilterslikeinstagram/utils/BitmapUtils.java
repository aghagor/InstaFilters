package com.example.goro.imagefilterslikeinstagram.utils;
...
public class BitmapUtils {
    ...
    public static Bitmap getBitmapFromGalery(Context context, Uri path, int width, int height) {
    ...
    public static Bitmap decodeSampedBitmapFromResource(Resources res, int resId, int reqWidth, int reqHeight) {
        final BitmapFactory.Options options = new BitmapFactory.Options();
        options.inJustDecodeBounds = true;
